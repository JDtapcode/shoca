        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMembership = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProPackages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumConcepts = table.Column<int>(type: "int", nullable: false),
                    NumRevisions = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FreelancerServices_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountProPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountProPackages_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccountProPackages_ProPackages_ProPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProPackageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_ProPackages_ProPackageId",
                        column: x => x.ProPackageId,
                        principalTable: "ProPackages",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatingComment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatingComment_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RatingComment_RatingComment_ParentCommentId",
                        column: x => x.ParentCommentId,
                        principalTable: "RatingComment",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RatingComment_Ratings_RatingId",
                        column: x => x.RatingId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountProPackages_AccountId",
                table: "AccountProPackages",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountProPackages_ProPackageId",
                table: "AccountProPackages",
                column: "ProPackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerServices_UserId",
                table: "FreelancerServices",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RatingComment_AccountId",
                table: "RatingComment",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingComment_ParentCommentId",
                table: "RatingComment",
                column: "ParentCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingComment_RatingId",
                table: "RatingComment",
                column: "RatingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ProPackageId",
                table: "Transactions",
                column: "ProPackageId");
